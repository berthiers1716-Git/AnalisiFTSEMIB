...
# =============================================================================
def log_totali_giornalieri(df_raw, analysis_date, log_path):
    """
    ...
    os.makedirs(os.path.dirname(log_path), exist_ok=True)
    cols = ['data', 'volume_totale', 'oi_totale']
    if os.path.exists(log_path):
    ...
    nuova_riga = pd.DataFrame([{'data': data_str, 'volume_totale': volume_totale, 'oi_totale': oi_totale}])
